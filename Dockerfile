...
# cmdline-tools must be recent enough to resolve SDK 37; the platform is published with a minor
# version (`platforms;android-37.0`), not a bare `android-37`.
RUN mkdir -p "$ANDROID_HOME/cmdline-tools" \
 && curl -fsSL https://dl.google.com/android/repository/commandlinetools-linux-15859902_latest.zip -o /tmp/cli.zip \
